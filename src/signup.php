                    ...
                    <div class="col-xs-4 col-xs-offset-4">
                        ...
                        <form method="post" action="user_registration_script.php">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" placeholder="Họ tên" required="true">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-lg btn-block" style="background-color: pink" value="Đăng ký">
                            </div>
                        </form>
                    </div>
                </div>
