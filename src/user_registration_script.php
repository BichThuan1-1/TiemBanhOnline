<?php
    ...
    if(!preg_match($regex_email,$email)){
        echo "Email của bạn không chính xác! Đang chuyển hướng về trang đăng ký...";
        ?>
    ...
    if(strlen($password)<6){
        echo "Mật khẩu phải có ít nhất 6 ký tự. Đang chuyển hướng bạn quay lại trang đăng ký...";
        ?>
        <meta http-equiv="refresh" content="2;url=signup.php" />
        <?php
    }
